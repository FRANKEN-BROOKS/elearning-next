...
{
    /// <inheritdoc />
    public partial class InitialCreateCourseDbContext : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountPriceThb = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lessons_CourseTopics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quizzes_CourseTopics_TopicId",
                        column: x => x.TopicId,
                        principalTable: "CourseTopics",
                        principalColumn: "Id",
